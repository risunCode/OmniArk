...
export abstract class BaseProvider {
   ...
   * supportedModels. Providers with a model-id prefix (qd-, kp-, codex-, ...)
   * override this with their own pattern, so adding/changing a provider's
   * models only touches that provider's file.
   */
